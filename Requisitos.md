...
Gerenciar Cardápio                   ──────────────────────────────────────────────── Admin. Restaurante
Gerenciar Pedidos Recebidos                                              
Configurar Horários de Funcionamento                                     
Visualizar Avaliações                                                    
                                                                           
Definir Disponibilidade              ──────────────────────────────────────────────── Entregador
...
#### UC01 — Cadastrar-se / Autenticar-se (Cliente)
...
| **Extensões** | Marcar item como indisponível temporariamente sem excluí-lo (UC12); duplicar item para criação rápida. |
...
| **Extensões** | Recusar entrega (UC21) sem penalidade até um limite de recusas consecutivas. |
...
#### NF-FF-004 — Segurança e Autenticação
...
#### NF-FF-007 — Rastreamento em Tempo Real
